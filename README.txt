THIS SCRIPT WILL WIPE OUT ANY OPERATING SYSTEMS ON YOUR FIRST HARD DRIVE SO MAKE SURE YOU EDIT THE SCRIPT OR HAVE THE ONLY DRIVE IN YOUR PC AS THE INSTALL LOCATION
...
10. Reboot and log in as the root user to get everything else set up
...
11. Run useradd -m "your user" and passwd "your user"
Replace "your user" with the username you want

12. Run EDITOR=nano visudo and add "your user" ALL=(ALL) ALL under the user privilege specification section
This will allow you to run commands using sudo as your main user

13. (Debatably optional) Customize to your heart's content
